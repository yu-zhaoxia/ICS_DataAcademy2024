...
- Example: 
$$y=\beta_0 + \beta_{age} age + \beta_f f + \beta_{age\times f} age\times f + \epsilon$$
where $f$ means female. 
...
- Male, similarly, the fitted line is
...
## Transformation $y=\beta_0 + \beta_1 log(x) + \epsilon$
